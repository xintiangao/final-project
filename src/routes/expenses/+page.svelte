...
<div class="text-center text-xl mt-5">Time To Input Your Expenses</div>
...
<div class="flex justify-center items-center mt-8">
    <form on:submit={InputExpenses} class="w-1/3">
        ...
        <div class="form-control w-full">
            ...
            <input type="number" name="minAnnualCompensation" placeholder="Amount" class="input input-bordered w-full" required />
